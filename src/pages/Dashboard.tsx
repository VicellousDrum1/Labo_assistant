      ...
      <div className="page-header">
        <div>
          <h1 className="page-title flex items-center gap-2">
            <BarChart3 size={22} className="text-primary-700" />
            Tableau de bord
          </h1>
          <p className="page-subtitle">Vue d'ensemble du parc informatique</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="card p-5 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              <div className="p-3 bg-ok-50 rounded-xl">
                <p className="text-xl font-bold text-ok-700">{s.osMigres}</p>
                <p className="text-xs text-gray-500 mt-0.5">Migrés</p>
              </div>
              <div className="p-3 bg-amber-50 rounded-xl">
                <p className="text-xl font-bold text-amber-700">{s.osEnCours}</p>
                <p className="text-xs text-gray-500 mt-0.5">En cours</p>
              </div>
              <div className="p-3 bg-danger-50 rounded-xl">
                <p className="text-xl font-bold text-danger-700">{s.osNonMigres}</p>
          ...
          <div className="card p-5 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              <div className="p-3 bg-ok-50 rounded-xl">
                <p className="text-xl font-bold text-ok-700">{s.offMigres}</p>
                <p className="text-xs text-gray-500 mt-0.5">Migrés</p>
              </div>
              <div className="p-3 bg-amber-50 rounded-xl">
                <p className="text-xl font-bold text-amber-700">{s.offEnCours}</p>
                <p className="text-xs text-gray-500 mt-0.5">En cours</p>
              </div>
              <div className="p-3 bg-danger-50 rounded-xl">
                <p className="text-xl font-bold text-danger-700">{s.offNonMigres}</p>
                <p className="text-xs text-gray-500 mt-0.5">Non migrés</p>
              </div>
            </div>
            <ProgressBar
