...
export function AuditPanel() {
  ...
  const actionColor: Record<string, string> = {
    CREATION: 'bg-ok-100 text-ok-700',
    MODIFICATION: 'bg-info-100 text-info-700',
    DESACTIVATION: 'bg-danger-100 text-danger-700',
    REACTIVATION: 'bg-teal-100 text-teal-700',
    SUPPRESSION: 'bg-danger-100 text-danger-700',
  }
            ...
            <div className="p-6 space-y-4">
              ...
              {selected.anciennes_valeurs && (
                <div>
                  ...
                  <pre className="text-xs bg-danger-50 border border-danger-100 rounded-lg p-3 overflow-auto max-h-32 scrollbar-thin">
              ...
              {selected.nouvelles_valeurs && (
                <div>
                  ...
                  <pre className="text-xs bg-ok-50 border border-ok-100 rounded-lg p-3 overflow-auto max-h-32 scrollbar-thin">
