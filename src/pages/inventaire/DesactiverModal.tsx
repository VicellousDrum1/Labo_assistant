        ...
        <>
          ...
          <form id="deactivate-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              {errors.motif && <p className="mt-1 text-xs text-red-600">{errors.motif.message}</p>}
            </div>
            ...
            <div>
              ...
              />
              {errors.observation && <p className="mt-1 text-xs text-red-600">{errors.observation.message}</p>}
            </div>
          </form>
        </>
      )}
