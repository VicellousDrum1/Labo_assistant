...
const REPORTS: ReportDef[] = [
  // Parc
  { id: 'inv_actifs',     label: 'PC en service',             description: 'Liste des matériels actifs en service',          icon: Package,    color: 'text-ok-700 bg-ok-50',  category: 'Parc informatique' },
  { id: 'inv_pannes',     label: 'PC en panne',               description: 'Matériels avec état "En panne"',                 icon: Package,    color: 'text-danger-700 bg-danger-50',      category: 'Parc informatique' },
  { id: 'inv_renouveles', label: 'PC renouvelés',             description: 'Matériels avec état "Renouvelé"',                icon: Package,    color: 'text-info-700 bg-info-50',    category: 'Parc informatique' },
  ...
  // Migrations
  { id: 'os_migres',      label: 'Migrations OS',             description: 'État de migration des systèmes d\'exploitation',  icon: Monitor,    color: 'text-info-700 bg-info-50', category: 'Migration' },
  { id: 'office_migres',  label: 'Migrations Office',         description: 'État de migration Microsoft Office',             icon: FileText,   color: 'text-info-700 bg-info-50',   category: 'Migration' },
  { id: 'os_non_migres',  label: 'OS non migrés',             description: 'Matériels avec OS non migré',                    icon: Monitor,    color: 'text-danger-700 bg-danger-50',     category: 'Migration' },
  { id: 'off_non_migres', label: 'Office non migrés',         description: 'Matériels avec Office non migré',                icon: FileText,   color: 'text-danger-700 bg-danger-50',     category: 'Migration' },
  // Mobilité
  ...
  { id: 'apk_deploiement',label: 'Déploiement APK',           description: 'État de déploiement APK par TSP',               icon: Download,   color: 'text-amber-700 bg-amber-50', category: 'Mobilité' },
  // Réseau
  ...
  // Support
  { id: 'di_ouvertes',    label: 'DI ouvertes',               description: 'Demandes d\'intervention non clôturées',         icon: Ticket,     color: 'text-amber-700 bg-amber-50', category: 'Support' },
  { id: 'ds_ouvertes',    label: 'DS ouvertes',               description: 'Demandes de service non clôturées',             icon: Ticket,     color: 'text-info-700 bg-info-50', category: 'Support' },
  { id: 'dids_critiques', label: 'Demandes critiques',        description: 'DI/DS avec priorité critique en cours',          icon: Ticket,     color: 'text-danger-700 bg-danger-50',     category: 'Support' },
  // Électrique
